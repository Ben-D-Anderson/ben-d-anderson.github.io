...
description: Running unit tests in isolated application domains, thus providing the ability to test a singleton-oriented codebase as if each unit test was running in a new instance of the application.
readtime: 6 minute
toc: true
tags: programming
---
